                    ...
                    <div className="flex items-center justify-between bg-blue-500/10 border border-blue-500/30 px-4 py-2 rounded-xl print:hidden">
                      ...
                      <div className="flex gap-2">
                        {logTab === 'active' ? (
                          ...
                          <button onClick={() => handleBulkArchive(false)} className="px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded text-xs font-bold">Restore to Active</button>
                        )}
