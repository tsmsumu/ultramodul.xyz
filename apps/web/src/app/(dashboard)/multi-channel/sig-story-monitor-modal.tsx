...
import { getMonitorTargets, getStoryLogs, addStoryTarget, removeStoryTarget, bulkDeleteLogs, bulkArchiveLogs, bulkDeleteTargets, importLogbookData } from "@/app/actions/sig-monitor";
...
export default function SigStoryMonitorModal({ providerId, onClose }: { providerId: string, onClose: () => void }) {
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar print:p-0 print:overflow-visible">
          {loading ? (
            ...
            <>
              ...
              {/* ANALYTICS TAB */}
              {activeTab === 'analytics' && (
                <LogAnalytics logs={filteredLogs} targets={targets} type="sigStory" />
              )}
                  ...
                  <div className="flex flex-col gap-4 print:hidden">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <ImportMenu type="sigStory" isLoading={importing} onImport={handleImportData} />
