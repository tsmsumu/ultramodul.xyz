...
import { getMonitorTargets, getChatLogs, addChatTarget, removeChatTarget, bulkDeleteLogs, bulkArchiveLogs, bulkDeleteTargets, importLogbookData } from "@/app/actions/sms-monitor";
...
export default function SmsChatMonitorModal({ providerId, onClose }: { providerId: string, onClose: () => void }) {
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar print:p-0 print:overflow-visible">
          {loading ? (
            ...
            <>
              ...
              {/* ANALYTICS TAB */}
              {activeTab === 'analytics' && (
                <LogAnalytics logs={filteredLogs} targets={targets} type="smsChat" />
              )}
                  ...
                  <div className="flex flex-col gap-4 print:hidden">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <ImportMenu type="smsChat" isLoading={importing} onImport={handleImportData} />
