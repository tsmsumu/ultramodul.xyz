...
import { getMonitorTargets, getStoryLogs, addStoryTarget, removeStoryTarget, bulkDeleteLogs, bulkArchiveLogs, bulkDeleteTargets, importLogbookData } from "@/app/actions/sms-monitor";
...
export default function SmsStoryMonitorModal({ providerId, onClose }: { providerId: string, onClose: () => void }) {
  ...
  const exportOptions = {
    ...
    title: "Omni Intelligence - SMS Blast Monitor",
    columns: [
      ...
      <div className="bg-zinc-950 border border-white/10 rounded-3xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden shadow-2xl print:h-auto print:border-none print:shadow-none">
        ...
        <div className="p-6 border-b border-white/10 flex justify-between items-center bg-zinc-900/50 print:hidden">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">SMS Blast Monitor</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar print:p-0 print:overflow-visible">
          {loading ? (
            ...
            <>
              ...
              {/* ANALYTICS TAB */}
              {activeTab === 'analytics' && (
                <LogAnalytics logs={filteredLogs} targets={targets} type="smsStory" />
              )}
                  ...
                  <div className="bg-black/40 border border-white/5 rounded-2xl overflow-hidden">
                    <div className="p-4 border-b border-white/5 bg-zinc-900/30 flex flex-col gap-4">
                      ...
                      <div className="relative w-full">
                        ...
                        <input 
                          type="text" 
                          placeholder="Cari target SMS Blast berdasarkan Nama atau Nomor..." 
                  ...
                  <div className="flex flex-col gap-4 print:hidden">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <ImportMenu type="smsStory" isLoading={importing} onImport={handleImportData} />
                    ...
                    <div className="relative w-full">
                      ...
                      <input 
                        type="text" 
                        placeholder="Ketik untuk mencari log SMS Blast..." 
                        value={searchQuery}
