...
import { getMonitorTargets, getChatLogs, addChatTarget, removeChatTarget, bulkDeleteLogs, bulkArchiveLogs, bulkDeleteTargets, importLogbookData } from "@/app/actions/tg-monitor";
...
export default function TgChatMonitorModal({ providerId, onClose }: { providerId: string, onClose: () => void }) {
                  ...
                  <div className="flex flex-col gap-4 print:hidden">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <ImportMenu type="chat" isLoading={importing} onImport={handleImportData} />
