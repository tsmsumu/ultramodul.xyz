...
import { getMonitorTargets, getGroupLogs, addGroupTarget, removeGroupTarget, bulkDeleteLogs, bulkArchiveLogs, bulkDeleteTargets, importLogbookData } from "@/app/actions/tg-monitor";
...
export default function GroupMonitorModal({ providerId, onClose }: { providerId: string, onClose: () => void }) {
