                    ...
                    <div className="p-4 border-b border-white/5 bg-zinc-900/30 flex flex-col sm:flex-row justify-between items-center gap-4">
                      <div className="relative w-full sm:w-96">
                        ...
                        <input 
                          ...
                          className="w-full bg-zinc-900 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-sm text-white focus:outline-none focus:border-emerald-500"
                        />
                      </div>
                      {selectedTargetRows.length > 0 && (
                        <div className="bg-emerald-900/20 px-4 py-2 border border-emerald-500/20 flex items-center gap-4 rounded-lg">
