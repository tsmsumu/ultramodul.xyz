...
export function TailorPanel({ onAddNode }: { onAddNode: (type: string, payload: any) => void }) {
  return (
    <>
       <div>
         <h3 className="font-bold text-xs tracking-wide text-gray-500 mb-2">1. IMPOR DATA (Server & File)</h3>
         <div className="space-y-2">
            ...
            >
              <span className="flex items-center gap-2"><Database className="w-4 h-4"/> DB Server Node</span>
            ...
            >
              <span className="flex items-center gap-2"><FileSpreadsheet className="w-4 h-4"/> DB File Node</span>
              <PlusCircle className="w-3 h-3 opacity-50" />
            </button>
         </div>
       </div>
       ...
       <div className="mt-4">
         <h3 className="font-bold text-xs tracking-wide text-gray-500 mb-2">2. IMPOR KAMUS (Metadata)</h3>
         <button 
           onClick={() => onAddNode('metadata', { label: 'Tarik Skema Variabel', dbName: 'Source: Oracle/Parquet' })}
         ...
         >
           <span className="flex items-center gap-2"><BookOpen className="w-4 h-4"/> Node Skema Kamus</span>
           <PlusCircle className="w-3 h-3 opacity-50" />
         </button>
       </div>

       <div className="mt-4">
         <h3 className="font-bold text-xs tracking-wide text-gray-500 mb-2">3. SULAM (Transformasi)</h3>
         <button 
       ...
       <div className="mt-4">
         <h3 className="font-bold text-xs tracking-wide text-gray-500 mb-2">4. TEMBAK EKSPOR (Destinasi)</h3>
         <div className="space-y-2">
            <button 
            ...
            >
              <span className="flex items-center gap-2"><Download className="w-4 h-4"/> Export ke File DB/Server</span>
              <PlusCircle className="w-3 h-3 opacity-50" />
            </button>
            <button 
