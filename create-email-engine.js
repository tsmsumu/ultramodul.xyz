...
fs.mkdirSync('apps/email-engine', { recursive: true });

const pkg = {
  name: 'email-engine',
  version: '1.0.0',
  description: 'Email IMAP/SMTP Intelligence Manager',
  main: 'index.js',
  scripts: {
    start: 'node index.js',
...
fs.writeFileSync('apps/email-engine/package.json', JSON.stringify(pkg, null, 2), 'utf8');
...
fs.writeFileSync('apps/email-engine/index.js', indexJs, 'utf8');
console.log('Created Email engine');
